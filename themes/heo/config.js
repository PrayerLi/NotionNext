const CONFIG = {
  ...
  // 示例{ title: '仅供个人资料的简要展示', url: 'https://docs.tangly1024.com' }
  NOTICE_BAR: [
    { title: '欢迎来到我的博客，如加载极慢请挂梯子', url: 'https://www.lizhipeng.me' },
    { title: '仅供个人资料的简要展示', url: '' }
  ],
  ...
  HERO_CATEGORY_2: { title: '知识总结', url: '/tag/专业知识' },
  HERO_CATEGORY_3: { title: '其它分享', url: '/tag/其他' },
